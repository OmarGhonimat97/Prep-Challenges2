...
function fullName(arr) {
    const full = arr.map(
        arr => `${arr.firstName} ${arr.lastName}`);
    return full;
    // write your code here
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    // write your code here
    let sum = 0;
    for (let i = 0; i < arr.gradsList.length; i++) {
        sum = sum + arr.gradsList[i];
        let avg2 = sum/arr.gradsList.length;
        return avg2 
    }
    const average1 = arr.map(element => ( 
        {
